...
int main(int argc, char *argv[])
{
    ...
    QGuiApplication::setApplicationName(QStringLiteral("乐乐代跑"));
    QGuiApplication::setOrganizationName(QStringLiteral("LeLeDaiPao"));
    ...
    qmlRegisterSingletonInstance("LeLeDaiPao", 1, 0, "Session", session);
    qmlRegisterSingletonInstance("LeLeDaiPao", 1, 0, "ImageUtil", new ImageUtil(&app));
    qmlRegisterSingletonInstance("LeLeDaiPao", 1, 0, "Updater", new Updater(&app));
